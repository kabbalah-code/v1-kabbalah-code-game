...
import { calculateLevel, getPointsForLevel } from "@/lib/points/calculator"
...
const SEPHIROT_DATA = [
  ...
  { id: 2, name: "Yesod", icon: Circle, required_level: 5, description: "Foundation - Connection" },
  { id: 3, name: "Hod", icon: Sparkles, required_level: 10, description: "Glory - Intellect" },
  { id: 4, name: "Netzach", icon: Zap, required_level: 15, description: "Victory - Emotions" },
  { id: 5, name: "Tiphereth", icon: Sun, required_level: 20, description: "Beauty - Harmony" },
  { id: 6, name: "Gevurah", icon: Shield, required_level: 30, description: "Strength - Judgment" },
  { id: 7, name: "Chesed", icon: Heart, required_level: 40, description: "Mercy - Kindness" },
  { id: 8, name: "Binah", icon: Eye, required_level: 50, description: "Understanding - Insight" },
  { id: 9, name: "Chokmah", icon: Brain, required_level: 60, description: "Wisdom - Creativity" },
